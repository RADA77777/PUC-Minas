...
class Prim
{
    private:
        ...
        void _prim_generate_mst(Graph *g, Graph *mst, int current_vertex);
...
void Prim::_prim_generate_mst(Graph *g, Graph *mst, int current_vertex)
{
    ...
    if(mst->adjacent_vertexes.size() != g->adjacent_vertexes.size())
    {
        ...
        this->_prim_generate_mst(g, mst, selected_destination_vertex);
    }
